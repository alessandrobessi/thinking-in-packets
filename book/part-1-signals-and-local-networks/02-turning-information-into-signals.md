...
**Link A: a satellite internet connection.** A ground station beams a signal up roughly 22,000 miles to a satellite in geostationary orbit, which beams it back down to a receiver on the other side of the world. This link can actually carry a substantial amount of data every second — modern satellite links are not narrow. But light itself, however fast, still takes a measurable amount of time to cover 44,000 miles round-trip: roughly a quarter of a second, before any equipment processing time is even added in. Send one tiny request — "give me the current time" — and even though almost no data was involved, you're still waiting through that same quarter-second round trip before any answer can possibly arrive. The link's *capacity* was barely touched; its *unavoidable delay* was the entire story.
